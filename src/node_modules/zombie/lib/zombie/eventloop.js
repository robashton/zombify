...
EventLoop = (function() {
  ...
  EventLoop.prototype.wait = function(duration, completion, callback) {
    var done, listener, timeout, timer, waitFor,
      _this = this;
    duration = ms(duration);
    waitFor = ms(this.browser.waitFor);
    ...
    listener = function(event, value) {
      var completed;
      switch (event) {
        case "tick":
          if (completion) {
            try {
              completed = completion(_this.active);
              if (completed) {
                done(null, false);
                return;
              }
...
Timeout = (function() {
  ...
  Timeout.prototype.resume = function() {
    ...
    this.handle = setTimeout(fire, this.delay);
...
Interval = (function() {
  ...
  Interval.prototype.resume = function() {
    ...
    this.handle = setInterval(fire, this.interval);
